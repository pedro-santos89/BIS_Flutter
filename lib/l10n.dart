...
class AppLocalizations {
  ...
  static const Map<String, String> _en = {
    ...
    'welcomeDescription': 'Manage Bus Member Registration, Info and a variety of other data',
    ...
    // Cloud Sync
    'cloudSync': 'Cloud Services, Backup and BIS Files Management',
    'cloudSyncSubtitle': 'Manage BIS Files, Backup, Restore and Sync Database with cloud services',
    'sectionCloudSync': 'CLOUD SERVICES',
    ...
    'restoreFromCloudConfirm': 'This will merge the latest cloud backup into your local database. Newer records will overwrite older ones. Continue?',
    'fullSync': 'Full Sync',
    ...
    'deleteFileConfirm': 'Delete "{name}" from cloud storage?',
    'noCloudFiles': 'No files in cloud storage',
    'refresh': 'Refresh',
    'browseCloudStorage': 'Download file(s)',
    'browseAndImport': 'Import data file from cloud',
    'exportMembersCsvCloud': 'Export Members CSV',
    'exportDailyMembersCsvCloud': 'Export Daily Members CSV',
    'exportAllCsvCloud': 'Export All CSV to Cloud',
    'exportDataToCloud': 'Export Data to Cloud',
    'selectTablesToExport': 'Select which tables to export as CSV files',
    'exportAllTables': 'Export All Tables',
    'exportAllTablesDesc': 'Members, Daily Members, and all Custom Tables',
    'selectAtLeastOne': 'Please select at least one table to export',
    'export': 'Export',
    'exportComplete': 'Export complete',
    'csvExportComplete': 'All CSV files exported successfully',
    ...
    'select': 'Select',
    'onlyJsonFiles': 'Only JSON backup files can be imported',
    'importFileConfirm': 'Import and merge data from "{name}" into the local database?',
    'importComplete': 'Import complete.',
    'configureGoogleDrive': 'Configure Google Drive',
    'googleDriveInstructions': 'Enter your Google Cloud OAuth2 Client ID and Secret. Create them at console.cloud.google.com → APIs & Services → Credentials.',
    'clientId': 'Client ID',
    'clientSecret': 'Client Secret',
    'configureDropbox': 'Configure Dropbox',
    'dropboxInstructions': 'Enter your Dropbox App Key. Create one at dropbox.com/developers/apps.',
    'appKey': 'App Key',
    'configureOneDrive': 'Configure OneDrive',
    'oneDriveInstructions': 'Enter your Azure App (client) ID. Register at portal.azure.com → App registrations.',
    'configureSupabase': 'Configure Supabase',
    'supabaseInstructions': 'Enter your Supabase project URL and anon key. Find them in your Supabase dashboard → Settings → API.',
  ...
  static const Map<String, String> _pt = {
    ...
    'welcomeDescription': 'Gerir Registo de Sócios BUS, Informação e uma variedade de outros dados',
    ...
    // Cloud Sync
    'cloudSync': 'Serviços Cloud, Backup e Gestão de Ficheiros BIS',
    'cloudSyncSubtitle': 'Gerir Ficheiros BIS, Backup, Restaurar e Sincronizar Base de Dados com serviços cloud',
    'sectionCloudSync': 'SERVIÇOS CLOUD',
    'cloudProviders': 'Fornecedores Cloud',
    'syncActions': 'Ações de Sincronização',
    'cloudFiles': 'Ficheiros Cloud',
    'connected': 'Conectado',
    'notConnected': 'Não conectado',
    'configure': 'Configurar',
    'connect': 'Conectar',
    'disconnect': 'Desconectar',
    'backupToCloud': 'Backup para Cloud',
    'restoreFromCloud': 'Restaurar da Cloud',
    'restoreFromCloudConfirm': 'Isto irá fundir o último backup da cloud na sua base de dados local. Registos mais recentes substituem os mais antigos. Continuar?',
    'fullSync': 'Sincronização Completa',
    'uploadFile': 'Carregar Ficheiro',
    'uploadFiles': 'Carregar Ficheiro(s)',
    'uploadToFolder': 'Carregar para Pasta',
    'selectThisFolder': 'Selecionar Esta Pasta',
    'downloadFile': 'Transferir',
    'importData': 'Importar Dados',
    'deleteFile': 'Eliminar Ficheiro',
    'deleteFileConfirm': 'Eliminar "{name}" do armazenamento cloud?',
    'noCloudFiles': 'Sem ficheiros no armazenamento cloud',
    'refresh': 'Atualizar',
    'browseCloudStorage': 'Descarregar ficheiro(s)',
    'browseAndImport': 'Importar ficheiro de dados da cloud',
    'exportMembersCsvCloud': 'Exportar Membros CSV',
    'exportDailyMembersCsvCloud': 'Exportar Membros Diários CSV',
    'exportAllCsvCloud': 'Exportar Todos CSV para Cloud',
    'exportDataToCloud': 'Exportar Dados para Cloud',
    'selectTablesToExport': 'Selecione as tabelas a exportar como ficheiros CSV',
    'exportAllTables': 'Exportar Todas as Tabelas',
    'exportAllTablesDesc': 'Membros, Membros Diários e todas as Tabelas Personalizadas',
    'selectAtLeastOne': 'Por favor selecione pelo menos uma tabela para exportar',
    'export': 'Exportar',
    'exportComplete': 'Exportação concluída',
    'csvExportComplete': 'Todos os ficheiros CSV exportados com sucesso',
    'emptyFolder': 'Esta pasta está vazia',
    'goBack': 'Voltar',
    'folders': 'pastas',
    'files': 'ficheiros',
    'filesSelected': 'ficheiros selecionados',
    'downloadSelected': 'Descarregar Selecionados',
    'selectDownloadFolder': 'Selecionar Pasta de Destino',
    'select': 'Selecionar',
    'onlyJsonFiles': 'Apenas ficheiros JSON de backup podem ser importados',
    'importFileConfirm': 'Importar e fundir dados de "{name}" na base de dados local?',
    'importComplete': 'Importação concluída.',
    'configureGoogleDrive': 'Configurar Google Drive',
    'googleDriveInstructions': 'Introduza o Client ID e Secret do Google Cloud OAuth2. Crie-os em console.cloud.google.com → APIs & Services → Credentials.',
    'clientId': 'Client ID',
    'clientSecret': 'Client Secret',
    'configureDropbox': 'Configurar Dropbox',
    'dropboxInstructions': 'Introduza a App Key do Dropbox. Crie uma em dropbox.com/developers/apps.',
    'appKey': 'App Key',
    'configureOneDrive': 'Configurar OneDrive',
    'oneDriveInstructions': 'Introduza o ID da aplicação Azure (client). Registe em portal.azure.com → App registrations.',
    'configureSupabase': 'Configurar Supabase',
    'supabaseInstructions': 'Introduza o URL do projeto Supabase e a chave anon. Encontre-os no dashboard Supabase → Settings → API.',
